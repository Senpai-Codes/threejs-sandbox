window.addEventListener("load", function () {
    ...
    var tex = THREE.ImageUtils.loadTexture("2k_earth_daymap.jpg");
    ...
    var pointer2 = new THREE.Mesh(
        new THREE.CylinderGeometry(2, 0, 10),
        new THREE.MeshPhongMaterial({color: 0xcc9900}));
    pointer2.position.set(55, 0, 0); // rotating obj should set (X > 0, 0, 0)
    pointer2.quaternion.setFromUnitVectors(
        new THREE.Vector3(0, 1, 0), new THREE.Vector3(1, 0, 0));
    var marker2 = new THREE.Object3D();
    marker2.add(pointer2);
    ...
    marker.quaternion.setFromEuler(
        ...
        marker2.quaternion.setFromEuler(
            new THREE.Euler(0, 10.046553 * rad, 35.399683 * rad, "YZX"));        
